...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-location-finder.js
  var import_location_finder_exports = {};
  __export(import_location_finder_exports, {
    default: () => import_location_finder_default
  });
  ...
  function parse(element, { document }) {
    ...
    const placeholderText = searchInput && (searchInput.getAttribute("placeholder") || "").trim() || "Search by city or ZIP code";
  ...
  var import_location_finder_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_location_finder_exports);
})();
