...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-stacked-content.js
  var import_stacked_content_exports = {};
  __export(import_stacked_content_exports, {
    default: () => import_stacked_content_default
  });
  ...
  var PAGE_TEMPLATE = {
    ...
    "urls": [
      "https://www.destinationpet.com/about-us/meet-the-team/"
    ],
    "coverageGaps": [],
    "description": "Two default-content sections stacked vertically without blocks",
    "blocks": [],
    "sections": [
      {
        "id": "rc1",
  ...
  var import_stacked_content_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_stacked_content_exports);
})();
